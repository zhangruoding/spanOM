...
from spanom.bert_embedder.adapter_embedder import AdapterTransformerEmbedder
...
if __name__ == "__main__":
    ...
    TextFieldEmbedder=TransformerMismatchedEmbedder(matched_embedder=matched_embedder)
    print(TextFieldEmbedder.get_output_dim())